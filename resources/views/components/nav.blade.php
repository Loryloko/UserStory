<nav class="navbar navbar-expand-lg navbar-dark navbar-dark bg-dark shadow-sm">
    <div class="container">
        
        <!-- Logo del sito (RIPRISTINATO) -->
        <a class="navbar-brand fw-bold fs-4" href="/">
            <i class="bi bi-lightning-charge-fill text-warning me-1"></i>Presto.it
        </a>
        
        <!-- Bottone hamburger per smartphone (RIPRISTINATO) -->
        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
            <span class="navbar-toggler-icon"></span>
        </button>
        
        <!-- Contenitore dei link ufficiale Bootstrap 5 -->
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0 gap-3 pt-3 pt-lg-0">
                ...
                @auth
                    <li class="nav-item">
                        <a class="btn btn-warning btn-sm fw-bold px-3 text-white d-inline-block" href="/announcements/create">
